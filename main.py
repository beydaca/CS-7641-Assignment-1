...
def load_dataset(dataset='heart'):
    '''Load a dataset
    '''
    if dataset == 'heart':
        log.info('Exploring heart dataset')
        dataset = pd.read_csv('./data/heart-final.csv')
        class_target = 'target'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', help='Which dataset to run on', choices=['heart', 'credit_card'], default='heart')
